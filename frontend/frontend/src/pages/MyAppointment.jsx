            ...
            {appointments.map((doc) => (
              ...
              >
                <div className="flex items-center justify-center">
                  ...
                  <div>
                    <div className="px-4">
                      ...
                      <p className="text-sm">{doc.doctorData.speciality}</p>
                    </div>
                ...
                <div className="mt-10 mr-10">
                  ...
                  {!doc.cancelled && !doc.payment && !doc.isCompleted && (
                    <button className="border border-black hover:bg-blue-500 hover:text-white hover:scale-105 transition-all duration:3000 px-4 w-full py-2 my-2">
                      Pay Online
                    </button>
                  )}
                  {!doc.cancelled && !doc.isCompleted && (
                    <button
                      className="border border-black hover:bg-red-500 hover:text-white hover:scale-105 transition-all duration:3000 px-4 w-full py-2 my-2"
                  ...
                  {doc.cancelled && !doc.isCompleted && (
                    <button className="border border-black bg-red-500 text-white  w-full px-4 py-2 my-2">
                      Appointment cancelled successfully
                    </button>
                  )}
                  {doc.isCompleted && (
                    <button className="border border-black bg-green-500  text-white  w-full px-4 py-2 my-2">
                      Completed
                    </button>
                  )}
                </div>
