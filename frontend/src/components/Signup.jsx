...
export const Signup = () => {
  ...
  const { settoken, backend_url } = useContext(myContext);
  ...
  return (
    <div className="flex justify-center items-center px-4 py-10 mt-10">
      <form
        onSubmit={handlesubmit}
        className="w-full max-w-md border border-gray-300 rounded-lg p-6 bg-white shadow-sm"
      >
        <h1 className="text-gray-700 font-semibold text-2xl mb-1">
          Create Account
        </h1>
